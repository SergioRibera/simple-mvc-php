<?php
    ...
    class Route
    {
        ...
        public static function get($expression, $function) { self::add($expression, $function, 'get'); }
        public static function post($expression, $function) { self::add($expression, $function, 'post'); }
